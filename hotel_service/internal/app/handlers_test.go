...
func TestHotelGet(t *testing.T) {
	...
	t.Run("empty id", func(t *testing.T) {
		...
		req := httptest.NewRequest(http.MethodPost, "/hotels/get", strings.NewReader(""))
		res := httptest.NewRecorder()
	...
	t.Run("non int id", func(t *testing.T) {
		...
		req := httptest.NewRequest(http.MethodPost, "/hotels/get?id=abcd", strings.NewReader(""))
		res := httptest.NewRecorder()
	...
	t.Run("error in database", func(t *testing.T) {
		...
		req := httptest.NewRequest(http.MethodPost, "/hotels?id=1", strings.NewReader(""))
		res := httptest.NewRecorder()
